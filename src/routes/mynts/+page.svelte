...
<div id="main">
    ...
    <br><br><h4>(DISCLAIMER: Mynt payments per accomplishment/task will be finalized closer to the commencement of this YSWS)</h4>
    <br><br><br>
    <div class="rank" >
        <h3>You can earn</h3>
        <h1>15 MYN</h1>
        <h3>for</h3>
        <br>
        <h2>Following the minimum <a href="/the-zoo/requirements">project requirements</a></h2>
        <br>
    </div>
    <h3>------------</h3><br><br>
    <div class="rank">
